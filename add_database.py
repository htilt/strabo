...
img3 = make_image(mock_flask_file_obj("test_images","download2.jpg"),"small flowers","1989","")
img4 = make_image(mock_flask_file_obj("test_images","download3.jpg"),"beach","2010","10")
img5 = make_image(mock_flask_file_obj("test_images","image with space.jpg"),"canyon","1998","")
img6 = make_image(mock_flask_file_obj("test_images","phone_testing.png"),"phone","1997","11")

img7 = make_image(mock_flask_file_obj("test_images","FishLadder2001.jpg"),"Fish Ladder Construction, November 2001","2001","10")
img8 = make_image(mock_flask_file_obj("test_images","FishLadderSmallSize.jpg"),"Fish Ladder Today","2009","6")
...
ip1 = make_interest_point([img1.id,img2.id,img3.id],"Interest Point 1","This is a descriptions of something",geo_obj1,"Plants","Navy")
ip2 = make_interest_point([img4.id],"Interest Point 2","This is a descriptions of something else",geo_obj2,"Animals","Green")
ip3 = make_interest_point([img7.id,img8.id],"Fish Ladder",ip3_description,geo_obj3,"Interest Points","Green")
